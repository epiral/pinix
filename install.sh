...
if [ "$INSTALL_MODE" = "cli" ]; then
  ...
  echo "================================================"
  echo ""
  echo "  Pinix CLI lets you invoke Clips on a remote"
  echo "  Pinix Hub — no local daemon needed."
  echo ""
  echo "  Quick start:"
  echo "    pinix --server https://hub.pinixai.com login"
  echo "      or: pinix --server https://hub.pinixai.com login --token pnx_..."
  echo ""
  echo "    pinix --server https://hub.pinixai.com list"
  echo "    pinix --server https://hub.pinixai.com invoke todo list"
  echo ""
  echo "  Want the full runtime (daemon + browser + Clips)?"
